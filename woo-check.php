...
// Enqueue CSS only on the checkout page
...
function customize_checkout_fields_order($fields) {
    ...
    // Define exact order for shipping fields (if needed)
